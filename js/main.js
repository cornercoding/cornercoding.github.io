...
(function() {
    ...
    var burgerMenu = function() {
        ...
        $('body')
            .on('click', '.js-qbootstrap-nav-toggle', function(event) {
    ...
    var countDownDate = new Date("Nov 19, 2018 18:37:25")
        .getTime();
    ...
    var x = setInterval(function() {
        ...
        document.getElementById("days")
            .innerHTML = days + " <small>days</small>";
        document.getElementById("hours")
            .innerHTML = hours + " <small>hours</small> ";
        document.getElementById("minutes")
            .innerHTML = minutes + " <small>minutes</small> ";
        document.getElementById("seconds")
            .innerHTML = seconds + " <small>seconds</small> ";

        // If the count down is finished, write some text
        if (distance < 0) {
            clearInterval(x);
            document.getElementById("demo")
                .innerHTML = "The Wedding Ceremony is Over";
        }
    }, 1000);
